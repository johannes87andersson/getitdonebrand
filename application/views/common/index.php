...
<div class="container" style="position: relative;">
    <div class="row">
        ...
        <div class="col-md-4">
            <a class="btn btn-warning start-page-btn" href="/common/about">About</a>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4 pull-left">
            <a class="btn btn-warning start-page-btn" href="/common/products">Products</a>
        </div>
        <div class="col-md-4">
            
        </div>
        <div class="col-md-4 pull-right">
            <a class="btn btn-warning start-page-btn" href="/common/contact">Contact</a>
        </div>-->
        <br />
        <br />
        <br />
        ...
        <div class="col-md-12">
            <div class="big-landpage-btn">
                <!--<a class="btn btn-primary">Event now</a>-->
            </div>
        </div>
        <div class="clearfix"></div>
    </div>
